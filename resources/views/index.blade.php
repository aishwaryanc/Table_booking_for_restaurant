      ...
      <div class="row msg-row">
        ...
        <div class="col-md-8 col-sm-8">
          <form action="store" method="post" >
            ...
            <div class="col-md-6 col-sm-6 contact-form">
              <div class="form-group">
                <input type="text" class="form-control label-floating is-empty" name="number" id="phone" placeholder="Phone" data-rule="required" data-msg="This field is required" />
                <div class="validation"></div>
              </div>
            </div>
            <div class="col-md-6 col-sm-6 contact-form">
            ...
            <div class="col-md-12 btnpad">
              <div class="contacts-btn-pad text-center">
                <input type="submit" name="submit" value="BookTable" class="btn btn-imfo btn-read-more">
              </div>
            </div>
          </form>
        </div>
        ...
        <div class="col-md-offset-3 col-md-6 text-center">
          <div class="widget">
            ...
            <p class="copyright clear-float">
              © Delicious Theme.
              <div class="credits">
                Designed by <a href="">Aishwarya</a>
              </div>
            </p>
          </div>
        </div>
